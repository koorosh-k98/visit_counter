...
class MobileCreateUrlScreen extends ConsumerStatefulWidget {
  const MobileCreateUrlScreen({super.key});

  @override
  ConsumerState<MobileCreateUrlScreen> createState() =>
      _MobileCreateUrlScreenState();
}

class _MobileCreateUrlScreenState extends ConsumerState<MobileCreateUrlScreen> {
